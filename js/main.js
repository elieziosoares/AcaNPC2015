...
if ('undefined' !== typeof window.ParsleyValidator)
  window.Parsley.addCatalog('pt-br', window.ParsleyConfig.i18n['pt-br'], true);
...
$(document).ready(function(){
  ...
  $(window).scroll(function() {
    if( $(this).scrollTop() > vpHeight ) {
      $mn.addClass('is-sticky');
    } else {
      $mn.removeClass('is-sticky');
    }
    ...
    $sections.each(function() {
      ...
      if (cur_pos >= top && cur_pos <= bottom) {
        $mn.find('a').removeClass('active');
        $sections.removeClass('active');

        $(this).addClass('active');
        $mn.find('a[href="#'+$(this).attr('id')+'"]').addClass('active');
      }
    });
  })


  $mn.find('a').on('click', function () {
    var $el = $(this),
        id = $el.attr('href');
  ...
  $('.js-go-to-target').on('click', function () {
    ...
    if (vpWidth <= 720) {
      ...
      point = $(target).offset().top - navHeight + 1;
    }    
  ...
  $(document).on('confirmation', '.remodal.js-modal-join', function () {
    var point;

    if (vpWidth <= 720) {
      point = $('#pagamento').offset().top;
    } else {
      point = $('#pagamento').offset().top - navHeight + 1;
    }
  ...
  $('.js-phone-number')
    .mask("(99) 9?9999-9999", { placeholder: "" })
    .blur(function (event) {
      ...
      element.unmask();  
      if(phone.length > 8) {  
        element.mask("(99) 9?9999-9999", { placeholder: "" });  
      } else {  
        element.mask("(99) 9?9999-9999", { placeholder: "" });  
      }  
    });
